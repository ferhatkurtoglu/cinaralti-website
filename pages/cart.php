            ...
            <div class="modal-body px-4 pt-0">
                ...
                <div class="donation-input-fields mb-4">
                    <div class="donation-input-field mb-3">
                        ...
                        <input type="text" id="donorName" class="form-control" value="Ferhat Kurtoğlu" placeholder="Ad Soyad">
                    </div>
                    ...
                    <div class="donation-input-field mb-3">
                        <div class="phone-input-container">
                            ...
                            <input type="tel" id="donorPhone" class="form-control" value="555 123 4567" placeholder="Telefon Numarası">
                        </div>
                    </div>
                    ...
                    <div class="donation-input-field">
                        ...
                        <input type="email" id="donorEmail" class="form-control" value="ferhatkurtoglu571@gmail.com" placeholder="E-posta Adresi">
                    </div>
                </div>
...
<style>
    ...
    @media (max-width: 768px) {
        ...
        .item-name, .donor-info, .quantity-price {
            width: 100%;
        }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function openEditModal(cartItem) {
            ...
            document.getElementById('updateDonationBtn').addEventListener('click', function() {
                ...
                const newType = document.querySelector('input[name="donationType"]:checked').value === 'zekat' ? 'Zekat Bağışı' : 'Standart Bağış';
