...
<div class="inner_banner-section">
  <h3 class="inner_banner-title">Hakkımızda</h3>
</div>
      ...
      <div class="col-xxl-6 col-lg-5 col-md-6 col-7">
        <div class="about_content-image-block ">
          <div class="about_content-image content-image--mobile-width">
            <img src="../public/assets/image/about/video-image.png" alt="alternative text">
          </div>
      ...
      <div class="col-xxl-6 col-lg-7 col-md-10 col-auto" data-aos-duration="1000" data-aos="fade-left">
        <div class="content">
          <div class="content-text-block">
            <h2 class="content-title heading-md text-black">Vizyonumuz markalar inşa etmek ve müşterilerimize dünya standartlarında deneyimler sunmaktır</h2>
          ...
          <div class="content-testimonial">
            ...
            <div class="content-testimonial__user-metadata">
              <div class="content-testimonial__user">
                <img src="../public/assets/image/about/user-image.png" alt="alternative text">
              </div>
  ...
  <div class="container">
    <div class="row row--custom ">
      <div class="col-xxl-auto  col-lg-7 col-md-10 col-auto">
        <div class="content">
          <div class="content-text-block">
            <h2 class="content-title heading-md text-black">Our creative talent has been influencing branding around
              the world for a long time</h2>
            <p>With more than a decade of experience. We are worry about the details so you need don't have to. When
              you work with our agency,
  ...
  <div class="container">
    ...
    <div class="row feature-widget-7-row  ">
      <div class="col-lg-4 col-md-6 col-xs-8 col-9">
        <div class="feature-widget-7">
          <div class="feature-widget-7__icon-wrapper">
            <img src="../public/assets/image/about/feature-icon-1.svg" alt="feature icon">
          </div>
      ...
      <div class="col-lg-4 col-md-6 col-xs-8 col-9">
        <div class="feature-widget-7">
          <div class="feature-widget-7__icon-wrapper">
            <img src="../public/assets/image/about/feature-icon-2.svg" alt="feature icon">
          </div>
          <div class="feature-widget-7__body">
      ...
      <div class="col-lg-4 col-md-6 col-xs-8 col-9">
        <div class="feature-widget-7">
          <div class="feature-widget-7__icon-wrapper">
            <img src="../public/assets/image/about/feature-icon-3.svg" alt="feature icon">
          </div>
          <div class="feature-widget-7__body">
      ...
      <div class="col-lg-4 col-md-6 col-xs-8 col-9">
        <div class="feature-widget-7">
          <div class="feature-widget-7__icon-wrapper">
            <img src="../public/assets/image/about/feature-icon-4.svg" alt="feature icon">
          </div>
          <div class="feature-widget-7__body">
      ...
      <div class="col-lg-4 col-md-6 col-xs-8 col-9">
        <div class="feature-widget-7">
          <div class="feature-widget-7__icon-wrapper">
            <img src="../public/assets/image/about/feature-icon-5.svg" alt="feature icon">
          </div>
          <div class="feature-widget-7__body">
      ...
      <div class="col-lg-4 col-md-6 col-xs-8 col-9">
        <div class="feature-widget-7">
          <div class="feature-widget-7__icon-wrapper">
            <img src="../public/assets/image/about/feature-icon-6.svg" alt="feature icon">
          </div>
          <div class="feature-widget-7__body">
  ...
  <div class="container">
    ...
    <div class="row row--portfolio-gutter">
      <div class="col-md-6 col-xs-10" data-aos-duration="1000" data-aos="fade-up" data-aos-delay="300">
        <a href="portfolio-details.html" class="portfolio-widget ">
          <div class="portfolio-widget_image-block">
            <img src="../public/assets/image/home-1/porfolio-img2.png" alt="portfolio image">
          </div>
      ...
      <div class="col-md-6 col-xs-10" data-aos-duration="1000" data-aos="fade-down" data-aos-delay="300">
        <a href="portfolio-details.html" class="portfolio-widget ">
          <div class="portfolio-widget_image-block">
            <img src="../public/assets/image/home-1/porfolio-img1.png" alt="portfolio image">
          </div>
          <div class="portfolio-widget__title-block">
            <h3 class="portfolio-widget__title">
    ...
    <div class="row justify-content-center">
      <div class="col-xxl-5 col-lg-6 col-md-8 col-10">
        <div class="section-heading text-center">
          <h2 class="section-heading__title heading-md text-black">Kalplere ve imanlara dokunan gönüllerin arkasında muhteşem bir ekip var</h2>
        </div>
      </div>
    </div>
    <div class="row team-card-2-row">
      <div class="col-lg-3 col-sm-6 col-8">
        <div class="team-card-2">
          <img src="../public/assets/image/about/team-image-1.png" alt="Team Member Image">
          <div class="team-card-2__body">
            <h4 class="team-card-2__name">Ofis Ekibimiz</h4>
      ...
      <div class="col-lg-3 col-sm-6 col-8">
        <div class="team-card-2">
          <img src="../public/assets/image/about/team-image-2.png" alt="Team Member Image">
          <div class="team-card-2__body">
            <h4 class="team-card-2__name">Kafe Ekibimiz</h4>
      ...
      <div class="col-lg-3 col-sm-6 col-8">
        <div class="team-card-2">
          <img src="../public/assets/image/about/team-image-3.png" alt="Team Member Image">
          <div class="team-card-2__body">
            <h4 class="team-card-2__name">Temizlik Ekibimiz</h4>
      ...
      <div class="col-lg-3 col-sm-6 col-8">
        <div class="team-card-2">
          <img src="../public/assets/image/about/team-image-4.png" alt="Team Member Image">
          <div class="team-card-2__body">
            <h4 class="team-card-2__name">Dış Ekip</h4>
    ...
    <div class="row justify-content-center">
      <div class="col-xxl-6 col-md-8">
        <div class="section-heading section-heading text-center">
          <h2 class="section-heading__title heading-md text-black">Çınaraltı hakkında sıkça sorulan sorular</h2>
        </div>
      </div>
    </div>
    <div class="row justify-content-center">
