...
const navigation = [
  ...
  { name: 'Blog Yazıları', href: '/dashboard/blog', icon: DocumentTextIcon },
  { name: 'Videolar', href: '/dashboard/videos', icon: VideoCameraIcon },
  { name: 'Kategoriler', href: '/dashboard/categories', icon: TagIcon },
];
    ...
    <div>
              ...
              <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                ...
                >
                  <div className="absolute left-full top-0 flex w-16 justify-center pt-5">
                    ...
                    >
                      <span className="sr-only">Sidebar'ı kapat</span>
                      <XMarkIcon
      ...
      <div className="lg:pl-72">
        <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
          ...
          >
            <span className="sr-only">Sidebar'ı aç</span>
